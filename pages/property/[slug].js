        ...
        <div className="container">
            ...
            <div className="section">
                <div className="information">
                    <h2><b><span className="capitalize">{propertyType}</span> hosted by {host?.name}</b></h2>
                    <h4>
                    {bedrooms} <span className="capitalize">bedroom{isMultiple(bedrooms)}</span> * {beds} <span className="capitalize">bed{isMultiple(beds)}</span>
                    </h4>
                ...
                <div className="price-box">
                    <h2>${pricePerNight}</h2>
                    <h4>{reviewAmount} review{isMultiple(reviews)}</h4>
